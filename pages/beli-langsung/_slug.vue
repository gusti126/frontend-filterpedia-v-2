<template>
  <div>
    ...
    <div class="md:px-20 px-2 pb-10" v-show="!load">
      ...
      <div class="my-2 md:mt-4 md:p-4 flex">
        <div>
          <img
            src="~/assets/icon/buy-button 1.png"
            alt="icon"
            class="md:w-16 w-14 mr-6"
          />
        </div>
        <div class="">
        ...
        <div class="md:col-span-4 col-span-12">
          <div class="border rounded p-3">
            ...
            <div class="flex">
              ...
              <div>
                <div class="">{{ items.product_name }}</div>

                <div class="">
                  <span class="text-green-700 text-sm font-semibold">
                    Rp. {{ items.product_price | currency }}
                  </span>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    async getData() {
      ...
      this.total = this.items.product_price + this.items.product_price * 0.1
