<template>
        <div class="fixed bottom-0  w-full md:hidden  px-2 py-2">
            <div class="bg-blue-700 flex justify-center py-2 rounded-full shadow" @click="showAlert">
                <svg
                ...
                <div class="text-white font-medium text-lg ml-4">Add To Cart</div>
            </div>
        </div>
</template>
    ...
    methods: {
        ...
        showAlert() {
            ...
            this.$swal({
                    ...
                    footer: `<a href="github.com" class="bg-blue-600 px-4 py-2 rounded-full text-white flex">
